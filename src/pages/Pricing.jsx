    ...
    <div className="font-sans bg-white min-h-screen">
      ...
      <div className="pt-10 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="relative p-10 bg-gradient-to-br from-brand-navy to-brand-green text-white rounded-[2.5rem] shadow-2xl transform scale-105 z-10">
            <div className="absolute top-0 right-0 bg-brand-gold text-slate-950 text-xs font-bold px-4 py-1.5 rounded-bl-2xl rounded-tr-[2rem]">
              MOST POPULAR
            </div>
            <h3 className="font-bold text-xl mb-2 text-brand-beige">Pro Growth</h3>
            <p className="text-brand-gold text-sm mb-6">For growing sales teams.</p>
            <div className="text-5xl font-extrabold mb-6">
              ₹2,999
              <span className="text-lg font-medium text-brand-beige">/mo</span>
            </div>
            <button className="w-full py-4 bg-white text-brand-green rounded-xl font-bold mb-8 hover:bg-brand-beige transition-colors shadow-lg">
              Start Free Trial
            </button>
            <ul className="space-y-4 text-sm text-brand-beige font-medium">

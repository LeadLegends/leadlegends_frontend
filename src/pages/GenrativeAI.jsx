      ...
      <section className="pt-10 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-500 max-w-3xl mx-auto mb-12 leading-relaxed">
            Stop writing emails manually. Our GenAI doesn't just draft text—it
            understands context, negotiates terms, and schedules meetings
            autonomously.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-slate-500 leading-relaxed">
                Agents that work 24/7 to nurture leads, answer queries, and book
            ...
            <div className="p-8 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-slate-500 leading-relaxed">
                Generates unique outreach for every prospect based on their
                LinkedIn activity and company news.
              </p>
            </div>
            ...
            <div className="p-8 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
              ...
              <p className="text-slate-500 leading-relaxed">
                Summarizes hour-long calls into actionable bullet points and
                updates the CRM in seconds.
              </p>
            </div>
          </div>
        </div>

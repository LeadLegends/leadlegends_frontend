...
const Solutions = () => {
   return (
      <div className="font-sans bg-slate-50 min-h-screen">
         ...
         {/* Header */}
         <div className="pt-10 pb-12 px-6 max-w-7xl mx-auto text-center">
            ...
            <div className="max-w-7xl mx-auto px-6">
               ...
               <div className="grid md:grid-cols-3 gap-12">
                  <div className="text-center">
                     ...
                     <p className="text-sm text-slate-500">Set up permissions, manage teams, and control data access for your entire organization.</p>
                  </div>
                  <div className="text-center">
                     ...
                     <h4 className="font-bold text-lg mb-2">Manager</h4>
                     <p className="text-sm text-slate-500">Monitor team performance, track pipeline health, and forecast revenue with confidence.</p>
                  </div>
                  <div className="text-center">
                     ...
                     <h4 className="font-bold text-lg mb-2">Sales Executive</h4>
                     <p className="text-sm text-slate-500">See a clear daily task list, follow-ups, and hot deals so you can focus on closing.</p>
                  </div>
               </div>
            </div>
         </div>

...
const Hero = () => {
  return (
    <section className="min-h-[calc(100vh-4rem)] flex items-center py-5 my-3">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-15 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          
          {/* Left Content */}
          <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-beige border border-brand-gold/30 text-brand-navy text-xs font-bold tracking-wide mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link
                to="/dashboard"
                className="inline-flex items-center justify-center gap-2 bg-brand-green hover:bg-brand-navy text-white px-8 py-4 rounded-full font-bold transition-all shadow-xl shadow-brand-green/20"
              >
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full font-bold text-brand-navy border border-gray-200 hover:border-brand-navy hover:bg-brand-beige transition-all"
              >
                Book Demo
              </Link>
            </div>
          ...
          <div className="lg:w-1/2 relative flex justify-center">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl border border-gray-200 p-3 transform rotate-1 hover:rotate-0 transition-all duration-500 w-full max-w-md">
              <div className="bg-gray-50 rounded-xl p-8 flex flex-col items-center justify-center h-80">
